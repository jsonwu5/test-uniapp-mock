...
Z([3,'__e'])
Z([3,'mini-btn'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[1,'initData']]]]]]]]])
Z([3,'mini'])
Z([3,'primary'])
Z([3,'拉取数据'])
Z(z[5])
...
var z=gz$gwx_2()
var oR=_n('view')
var fS=_mz(z,'view',['class',0,'scrollY',1],[],e,s,gg)
var cT=_n('text')
...
var lY=_mz(z,'button',['bindtap',5,'class',1,'data-event-opts',2,'size',3,'type',4],[],e,s,gg)
var aZ=_oz(z,10,e,s,gg)
_(lY,aZ)
_(oX,lY)
var t1=_mz(z,'button',['bindtap',11,'class',1,'data-event-opts',2,'size',3,'type',4],[],e,s,gg)
...
var x5=_mz(z,'view',['bindtap',1,'class',1,'data-event-opts',2,'hoverClass',3],[],e,s,gg)
var o6=_mz(z,'image',['class',5,'src',1],[],e,s,gg)
_(x5,o6)
var f7=_n('view')
...
__wxAppCode__['pages/test/mock-test.wxss']=setCssToHead(["wx-button { margin-top: ",[0,20],"; margin-bottom: ",[0,30],"; }\n.",[1],"button-sp-area { margin: 0 auto; width: 60%; }\n.",[1],"mini-btn { margin-right: ",[0,20],"; }\n.",[1],"text-box { margin: ",[0,10]," ",[0,20]," ",[0,40]," ",[0,20],"; border: #007aff dashed ",[0,1],"; padding: ",[0,40]," 0; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; min-height: ",[0,300],"; background-color: #ffffff; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; text-align: center; font-size: ",[0,25],"; color: #353535; line-height: 1.8; }\n",],undefined,{path:"./pages/test/mock-test.wxss"});    
